        ...
        <div>
            ...
            <div class="input-group">
                <div class="input-group-text">
                    <input type="checkbox" class="form-check-input mx-1 mb-1"
                        aria-label="checkbox for checking marketing" id="marketing" value="Marketing"
            ...
            <div>
                <button @click="handleAddTask" class="btn btn-primary my-3">Add Item<i
                        class="bi bi-clipboard ps-2"></i></button>
            </div>
        </div>
    </section>
</template>
